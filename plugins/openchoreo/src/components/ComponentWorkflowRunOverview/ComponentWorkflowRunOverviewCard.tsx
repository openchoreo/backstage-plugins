...
export const ComponentWorkflowRunOverviewCard = () => {
  ...
  const componentName = spec.componentName as string | undefined;
  const projectName = spec.projectName as string | undefined;
  const workflowName = spec.workflowName as string | undefined;
  const commit = spec.commit as string | undefined;
  ...
  return (
    <Card padding={24} className={classes.card}>
      ...
      <Box className={classes.statusGrid}>
        ...
        {componentName && (
          <Box className={classes.statusItem}>
            <CodeIcon className={classes.statusIcon} />
            <Box>
              <Typography className={classes.statusLabel}>Component</Typography>
              <Typography className={classes.statusValue}>
                <Link
                  to={`/catalog/${namespace}/component/${componentName}`}
                >
                  {componentName}
                </Link>
              </Typography>
      ...
      {projectName && (
        <Box mt={2}>
          ...
          <Typography className={classes.statusValue}>
            <Link to={`/catalog/${namespace}/system/${projectName}`}>
              {projectName}
            </Link>
          </Typography>
        </Box>
