  ...
  return (
    <Grid container>
      ...
      */}
      ...
      {(() => {
        // All labels except the internal managed marker.
        const metadataLabels = Object.entries(
          entity?.metadata?.labels ?? {},
        ).filter(([key]) => key !== CHOREO_LABELS.MANAGED);
        if (metadataLabels.length === 0) return null;
        return (
          <Grid item xs={12}>
            <AboutField label="Labels" value="No Labels">
