...
- 7c76d05: Add `resource.resourceType` ABAC condition to resource update, gating the resource definition editor per resource type.
...
- 8381554: Fix the "Add Trait" / "Update Trait" button staying disabled in the YAML
...
- 8381554: Add JSON Schema → annotated YAML utilities (`buildYamlString`,
...
- Support for resource entities in the project overview page. (#590)
- Permission hook gating Resource Deploy actions on environment-scoped permissions. (#577)
