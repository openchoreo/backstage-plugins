      ...
      switch (kind) {
        ...
        case 'projects': {
          const { data, error, response } = await client.GET(
            ...
            {
              params: {
                path: { namespaceName, projectName: resourceName },
              },
            },
          );
          assertApiResponse(
        ...
        case 'projecttypes': {
          const { data, error, response } = await client.GET(
            ...
            {
              params: {
                path: { namespaceName, ptName: resourceName },
              },
            },
          );
          assertApiResponse(
        ...
        case 'clusterresourcetypes': {
          const { data, error, response } = await client.GET(
            '/api/v1/clusterresourcetypes/{crtName}',
            {
              params: {
                path: { crtName: resourceName },
              },
            },
          );
          assertApiResponse(
        ...
        case 'clusterprojecttypes': {
          const { data, error, response } = await client.GET(
            '/api/v1/clusterprojecttypes/{cptName}',
            {
              params: {
                path: { cptName: resourceName },
              },
            },
          );
          assertApiResponse(
        ...
        case 'clusterobservabilityplanes': {
          const { data, error, response } = await client.GET(
            ...
            {
              params: {
                path: { clusterObservabilityPlaneName: resourceName },
              },
            },
          );
          assertApiResponse(
