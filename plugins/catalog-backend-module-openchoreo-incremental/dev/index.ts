...
async function main(): Promise<void> {
  ...
  // Note: @backstage/plugin-catalog-backend is intentionally not added here;
  // it is not a dependency of this module package.
  backend.add(import('../src'));
  backend.add(dummyProvider);
  await backend.start();
}

// Entry point for `yarn start` in this package. Not executed on import.
void main();
