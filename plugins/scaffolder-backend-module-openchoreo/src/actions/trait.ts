  ...
  return createTemplateAction({
    ...
    schema: {
      input: {
        namespaceName: z =>
          z.string({
            description: 'The name of the namespace to create the Trait in',
          }),
        yamlContent: z =>
          z.string({
            description: 'The YAML content of the Trait definition',
          }),
      },
      output: {
        traitName: z =>
          z.string({ description: 'The name of the created Trait' }),
        namespaceName: z =>
          z.string({
            description: 'The namespace where the Trait was created',
          }),
        entityRef: z =>
          z.string({
            description: 'Entity reference for the created Trait',
          }),
      },
    },
    async handler(ctx) {
