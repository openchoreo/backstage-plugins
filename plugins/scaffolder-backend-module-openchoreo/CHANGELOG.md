...
- e0f0285: Authenticate backend-to-backend calls (scaffolder catalog reads and the
...
- Updated dependencies [aa9d937]
  - @openchoreo/backstage-plugin-catalog-backend-module@1.2.2
