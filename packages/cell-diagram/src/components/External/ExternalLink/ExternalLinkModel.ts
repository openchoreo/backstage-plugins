...
export class ExternalLinkModel extends SharedLinkModel {
  ...
  getArrowHeadPoints = (): string => {
    ...
    if (
      ...
      points = `${targetPort.x + 6} ${targetPort.y}, ${targetPort.x + 16} ${
        targetPort.y + 10
      },
      ...
      points = `${targetPort.x} ${targetPort.y}, ${targetPort.x - 14} ${
        targetPort.y + 10
      },
      ...
      points = `${targetPort.x} ${targetPort.y + 2}, ${targetPort.x + 10} ${
        targetPort.y + 14
      },
      ...
      points = `${targetPort.x} ${targetPort.y}, ${targetPort.x + 10} ${
        targetPort.y - 15
      },
