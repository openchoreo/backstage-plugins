  ...
  return (
    <div>
      <div className={classes.helpText}>
        <span>
          Customize the Trait definition below. For available fields and
...
export const traitYamlEditorValidation = (
  value: string,
  validation: FieldValidation,
) => {
  if (!value || value.trim() === '') {
    validation.addError('Trait YAML definition is required');
    return;
  }
  ...
  try {
    ...
    if (parsed.kind !== 'Trait') {
      validation.addError('Kind must be Trait');
    }
